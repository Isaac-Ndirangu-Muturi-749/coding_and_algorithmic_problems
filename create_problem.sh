...
echo "## Name: $problem_name" > "$base_dir/README.md"
echo "## Type: $problem_type" >> "$base_dir/README.md"
echo "### Problem: problem.md" >> "$base_dir/README.md"
echo "### Solution: solution.py" >> "$base_dir/README.md"
echo "### Tests: test_cases.py" >> "$base_dir/README.md"
